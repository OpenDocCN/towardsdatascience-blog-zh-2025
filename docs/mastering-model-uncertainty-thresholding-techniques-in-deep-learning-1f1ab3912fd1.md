...
为了说明阈值在现实世界情况中的价值，让我们考虑一个金融机构的任务，即检测欺诈交易。我们将使用[Kaggle 欺诈检测数据集](https://www.kaggle.com/datasets/mlg-ulb/creditcardfraud/data)（DbCL 许可证），其中包含带有欺诈活动标签的匿名交易数据。这些机构处理大量交易，手动审查每一笔交易变得困难。我们希望开发一个系统，能够准确标记可疑交易，同时最大限度地减少不必要的干预。
...
![应用 softmax 后的二十个预测样本。](img/03ed39dfe32f5ccbeb0b48fdb7fd1a84.png)
...
![整个未设置阈值的测试数据集的混淆矩阵。](img/3c4faf070ef2c77af4c06a8d155154d6.png)
...
![在应用 softmax 转换之前，二十个预测样本](img/21e6c7bf92a63596c05d9918350a85ab.png)
...
希望您觉得这篇文章有用或鼓舞人心。如果您有任何评论或问题，请与我联系。您也可以在[LinkedIn](https://www.linkedin.com/in/hampus-gustavsson-23721a116/)上与我联系。
