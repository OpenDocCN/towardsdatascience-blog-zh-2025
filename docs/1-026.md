...
> [`towardsdatascience.com/overcoming-the-hidden-performance-traps-of-variable-shaped-tensors-efficient-data-sampling-in-pytorch/`](https://towardsdatascience.com/overcoming-the-hidden-performance-traps-of-variable-shaped-tensors-efficient-data-sampling-in-pytorch/)
...
1.  **最大化计算单元的并行化**：GPU 是高度并行的计算引擎。我们能够并行化的计算越多，就越能饱和 GPU 并提高其利用率。通过批处理，我们可以通过批量大小的倍数增加并行化的程度。
...
![](img/af5b1a08ff417e8bd50bccd1dc65e28a.png)
...
我们提出了一种替代的采样函数实现，用静态的[tensor.count_nonzero](https://docs.pytorch.org/docs/stable/generated/tensor.count_nonzero.html)、[tensor.topk](https://docs.pytorch.org/docs/stable/generated/tensor.topk.html)和其他 API 的组合来替换动态的 torch.nonzero 函数：
...
![](img/e0680690e47a89b578a241ca6ca2df7e.png)
...
![](img/582a4d12f0657864a0a5df28442939ac.png)
...
![](img/d562107006270e767fd986b311b55476.png)
...
+   **通过性能分析发现：**使用[PyTorch 分析器](https://pytorch.org/tutorials/recipes/recipes/profiler_recipe.html)，我们能够识别 GPU 利用率下降，并发现其来源：torch.nonzero 操作产生的可变形状张量。
