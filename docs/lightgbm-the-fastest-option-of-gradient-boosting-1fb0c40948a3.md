...
> 原文：[`towardsdatascience.com/lightgbm-the-fastest-option-of-gradient-boosting-1fb0c40948a3/`](https://towardsdatascience.com/lightgbm-the-fastest-option-of-gradient-boosting-1fb0c40948a3/)

![LightGBM 是一个更快的选项 | 由 AI 生成的图像。Meta Llama，2025 年。https://meta.ai](img/fb9d4ff8907de65a68d302d269c5e39b.png)

LightGBM 是一个更快的选项 | 由 AI 生成的图像。Meta Llama，2025 年。[`meta.ai`](https://meta.ai)
...
**LightGBM**旨在解决这个问题。该包提供了一个更轻量级的算法实现，专注于：
...
数据大多是数值型，作为整数变量。例外的是`URL`、`Domain`、`TLD`和`Title`。
...
好的，很好。没有缺失值。正如我们所说的，只有这 4 个分类变量。众所周知，LightGBM 可以原生处理类别，但你应该将数据类型从`object`转换为`category`。这可以通过下一个代码片段轻松完成。
...
![比较模型 | 由 AI 生成的图像。Meta Llama，2025 年。https://meta.ai](img/d4e54003be2dbe230727eba3857c228b.png)

比较模型 | 由 AI 生成的图像。Meta Llama，2025 年。[`meta.ai`](https://meta.ai)
...
使用这个算法进行拟合和预测花费了**15 分钟**。而且数据量并不大。
...
> [**古斯塔沃·R·桑托斯 – Medium**](https://gustavorsantos.medium.com)
> 
> [**古斯塔沃·R·桑托斯**](https://gustavorsantos.me)

### Git Hub

这里是包含此练习全部代码的仓库。

> [**Studying/Python/LightGBM 在 master · gurezende/Studying**](https://github.com/gurezende/Studying/tree/master/Python/LightGBM)
