...
> 原文：[`towardsdatascience.com/spearman-correlation-coefficient-for-when-pearson-isnt-enough/`](https://towardsdatascience.com/spearman-correlation-coefficient-for-when-pearson-isnt-enough/)
...
![](img/4734c6e7217dc7c2f8110c1604188d23.png)
...
之前，我们得到了身高和体重之间的**Pearson 相关系数为 0.72**，这低估了这些变量之间的实际关系。
...
![图片](img/894e01dca3b5497be083e5d7dece1c81.png)

图片由作者提供

现在，我们在每个列中按升序排序值，然后分配排名。

![图片](img/3175b9af56047b0790712fd24463c437.png)
...
![图片](img/d4aa66bcce36284c1f26c495f904d56c.png)

图片由作者提供

在这里，当我们对**体重**列中的值按升序排序并分配排名时，我们在排名**5 和 6**处遇到了平局，所以我们给这两个值分配了**平均排名 5.5**。

同样，我们在排名**7, 8, 9, 和 10**之间发现了一个平局，所以我们给所有这些分配了**平均排名 8.5**。

现在，我们计算**Spearman 相关系数**，这实际上是**将 Pearson 相关系数应用于排名**。
...
\underbrace{(R_{X_i} – \bar{R}_X)²}_{\text{X 的平方等级偏差}}
...
\underbrace{(R_{Y_i} – \bar{R}_Y)²}_{\text{Y 的平方等级偏差}}
...
它在 Kaggle 上公开发布，并受[**Creative Commons Zero (CC0 公共领域**)](https://creativecommons.org/publicdomain/zero/1.0/)许可协议的约束。这意味着它可以无限制地自由使用、修改和共享，无论是用于**非商业目的**还是**商业目的**。
