...
> 原文：[`towardsdatascience.com/how-to-build-a-powerful-deep-research-system/`](https://towardsdatascience.com/how-to-build-a-powerful-deep-research-system/)

<mdspan datatext="el1759451438162" class="mdspan-comment">深度研究</mdspan> 是你可以在 ChatGPT 和 Google Gemini 等应用程序中激活的流行功能。它允许用户像平常一样提出查询，应用程序会花费更长的时间对问题进行适当的调查，并给出比普通 LLM 响应更好的答案。

你也可以将此应用于你自己的文档集合。例如，假设你拥有成千上万份内部公司信息文档，你可能希望创建一个深度研究系统，该系统能够接收用户问题，扫描所有可用的（内部）文档，并根据这些信息提供良好的答案。

![深度研究系统](img/2aaf29622584a3c878d079c396cb4df8.png)
...
您可以自然地利用来自 OpenAI 等提供商的深度研究系统，它提供了一个[深度研究 API](https://platform.openai.com/docs/guides/deep-research)。如果您希望保持简单，这可以是一个不错的选择。然而，在这篇文章中，我将更详细地讨论如何构建深度研究系统，以及为什么它是有用的。Anthropic 撰写了一篇非常好的文章，关于他们的[多智能体研究系统](https://www.anthropic.com/engineering/multi-agent-research-system)（即深度研究），我推荐您阅读以了解更多关于这个主题的细节。
...
![图片](img/d99842f2cd1b7a73a02b24259d25dc56.png)
...
+   [如何在 LLM 应用中确保可靠性](https://eivindkjosbakken.com/2025/08/16/how-to-ensure-reliability-in-llm-applications/)

+   [如何进行大规模 LLM 的综合验证](https://eivindkjosbakken.com/2025/09/24/how-to-perform-comprehensive-large-scale-llm-validation/)
