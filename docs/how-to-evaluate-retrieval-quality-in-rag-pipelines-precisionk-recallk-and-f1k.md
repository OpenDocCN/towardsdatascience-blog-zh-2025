...
> 🍨*[**DataCream**](https://datacream.substack.com/) 是一个提供关于 AI、数据、技术的故事和教程的通讯。如果你对这些主题感兴趣，**[在此订阅](https://datacream.substack.com/).***

**. . .**

## 为什么关注度量检索性能

因此，我们的目标是评估我们的嵌入模型和向量数据库检索候选文本块的效果如何。本质上，我们在这里试图弄清楚的是“*在检索到的前 k 个文档中是否有正确的文档*？”，或者我们的向量搜索是否返回了完全无用的信息？🙃我们可以利用几种不同的度量标准来回答这个问题。其中大部分源自[信息检索](https://en.wikipedia.org/wiki/Information_retrieval)领域。
...
![](img/78febed1d9c027fa054d631acfea325f.png)
...
![](img/d180b049d761e2f5426b40417aab1e88.png)

图片由作者提供

这样，我们可以计算测试集中所有查询和检索结果的不同的命中率，并最终计算整个测试集的平均 HitRate@K。

![](img/d6b8ee69c9df96a5ed24c5c9b966064c.png)
...
![](img/898f9ef1c8f2a9895ef055ebb24ed962.png)
...
![](img/f478f0f6db5e8828f31ccb0c37d4448a.png)
...
![图片](img/754486d299c504610f1eb942ab454838.png)
...
注意到我们在**重排序**之后运行评估。因为我们计算的指标——如 Precision@K、Recall@K 和 F1@K——**是无序的，所以在重排序前后对前 k 个检索到的块进行评估，只要前 k 个项的集合保持不变，结果都是相同的。**

因此，对于我们的问题“*谁是安娜·帕夫洛夫娜*？”和@k = 10，我们得到以下分数：

![](img/7478c61297f65ef77c31465220eb39ce.png)
