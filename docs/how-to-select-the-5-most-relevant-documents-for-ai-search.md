...
> 原文：[`towardsdatascience.com/how-to-select-the-5-most-relevant-documents-for-ai-search/`](https://towardsdatascience.com/how-to-select-the-5-most-relevant-documents-for-ai-search/)
...
![](img/143ac54515e2c37160d1921d4ad7f67f.png)
...
1.  最相关的文档（或片段）被输入到 LLM 中，并提示它根据提供的片段回答用户问题。

![图片](img/b0fbac7b43d8d2bed9fae4df9f46243b.png)
...
![图片](img/403564bca0d39ab0987c6eb9f0f7cfd7.png)
...
[上下文检索](https://www.anthropic.com/engineering/contextual-retrieval)是 Anthropic 在 2024 年 9 月引入的一种技术。他们的文章涵盖了两个主题：向文档片段添加上下文以及将关键词搜索（BM25）与语义搜索相结合以获取相关文档。
