...
> 原文：[`towardsdatascience.com/how-to-code-your-own-website-with-ai/`](https://towardsdatascience.com/how-to-code-your-own-website-with-ai/)

<mdspan datatext="el1764704432098" class="mdspan-comment">WordPress 是一个常见的</mdspan>个人网站托管平台，在这里你可以展示你的作品集和其他关于自己的有用资源。在我转换之前，我已经使用 WordPress 大约 1 年了，我开始思考在使用 WordPress 时遇到的一些困难：
...
![信息图表：创建自己的网站](img/3292f2e32092f8e78e01917b760a512a.png)
...
![Speaking Page](img/982da85fec0f50129ea1b1370d90af30.png)
...
我首先通过以下方式提示克劳德代码，其中*eivindkjosbakken.com*是我的 WordPress 网站：
...
然而，在首次部署时，我必须在*vercel.com*上创建一个项目，并将我的代码库连接到该项目。你可以询问任何 LLM 如何做，他们将会给你一个准确的逐步指南，告诉你如何将你的代码连接到 Vercel。Vercel 还为你提供每天 100 次免费的部署，这应该绰绰有余。
...
![文章突出显示](img/96a0ae147564cf69a9ad7d45861f6eb8.png)
