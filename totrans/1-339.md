...
> 原文：[`towardsdatascience.com/what-is-universality-in-llm-and-how-to-find-universal-neurons/`](https://towardsdatascience.com/what-is-universality-in-llm-and-how-to-find-universal-neurons/)
...
![图片](img/3e6cf393854acb78c98e491e7fb320c4.png)

图片由作者提供：大脑中的普遍性

在 2020 年，[Olah 等人](https://distill.pub/2020/circuits/zoom-in/)提出了关于解释人工神经网络的三个推测性主张：
...
![图片](img/06629888ec10a8d0b8433e1b38839ee2.png)

图片由 Olah 等人提供：在 4 个不同的视觉模型中发现的曲线检测电路

在这篇博客文章中，我们将关注一个简单的实验，并识别普遍神经元。更确切地说，我们将设计一个包含两个不同变换器的实验，看看我们是否能在它们之间找到任何普遍神经元。

请参阅[笔记本](https://colab.research.google.com/drive/1FtRmJwcluX1met0msVjPnxLY-ZDsYNGV)以获取完整的 Python 实现。
...
1.  前馈 MLP**：**在注意力之后，每个标记表示通过一个小型 MLP。
...
![](img/915c86d85560d9fda671361b4ba3f12d.png)
...
![](img/4fdef5c55823b4c2b09f4f2d41ea34aa.png)
