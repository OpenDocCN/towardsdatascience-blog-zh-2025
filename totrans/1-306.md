...
> 原文：[`towardsdatascience.com/langchain-for-eda-build-a-csv-sanity-check-agent-in-python/`](https://towardsdatascience.com/langchain-for-eda-build-a-csv-sanity-check-agent-in-python/)
...
我们使用[LangChain 框架](https://www.langchain.com/)作为代理。这允许我们将 LLMs 与工具连接起来，并构建具有定义行为的系统。系统可以执行操作，而不仅仅是提供答案或生成文本。详细的解释会使这篇文章太长。但在之前的文章中，你可以找到 LangChain 的解释以及与 Langflow 的比较：[LangChain vs Langflow：使用代码或拖放构建简单的 LLM 应用程序](https://medium.com/data-science-collective/langchain-vs-langflow-build-a-simple-llm-app-with-code-or-drag-drop-cbace40c12b1)。
...
![这张图片显示了传统应用程序和这个代理之间的区别。](img/c1a6ca970dccd2a96919f1b644fc3aef.png)
...
![图像显示了创建环境和安装包的过程。](img/2b28d0222ef24dbf60e833cc58e8ca80.png)
...
![图像显示了 csv 保存后终端中的结果。](img/d57ffc543eccc46a2359cdb1c75df039.png)

作者拍摄的截图。

![图像显示了项目的文件夹结构。](img/dcf157da1cc2cbec5d182b4c824ebe2f.png)
...
![图像显示了 Excel 中的泰坦尼克号数据集。](img/91b322b1d04b64c9d501def1e9097f83.png)
...
![该图像显示了代理如何使用工具进行多步骤推理。](img/df70afb61c2552613bac21a3f6e006e4.png)
...
![该图像显示了如何在 OpenAI 中创建 API 密钥。](img/a8434e3f3a33020358aaeb4c1260b1f8.png)
...
![该图像显示了如何在终端中检查 API 密钥是否已保存。](img/1e8643114bfae0bda613198c34a9e846.png)
...
![该图像显示了智能体在终端中显示的结果（缺失值数量）](img/d35936b13da1ec02ed38712d0128883a.png)
...
![图像显示了小型评估的结果。](img/1312936a3f9c2490104bcd15f04fe0c2.png)

由作者拍摄的截图。

* * *

你可以在 GitHub 上的[仓库](https://github.com/Sari95/langchain-eda-with-csv-agent/tree/main)中找到代码和 csv 文件。

在我的[*Substack 数据科学咖啡厅*](https://sarahleaschrch.substack.com/)上，我分享来自数据科学、Python、AI、机器学习和科技领域的实用指南和精简更新——专为像你这样好奇的心灵而准备。

查看并订阅[Medium](https://medium.com/@schuerch_sarah)或 Substack，如果你想保持最新动态。
...
最后，在我们的例子中，我们手动定义了三个工具模式、nulls 和 describe。通过[模型上下文协议](https://www.anthropic.com/news/model-context-protocol) (MCP)，我们可以以标准化的方式连接工具。例如，我们可以连接数据库、API 或 IDE。
...
+   [IBM 技术视频 – 什么是 LangChain?](https://www.youtube.com/watch?v=1bUy-1hGZpI)
