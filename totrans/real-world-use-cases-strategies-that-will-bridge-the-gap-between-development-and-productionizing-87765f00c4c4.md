...
![由 Dall-e 生成的图像。本文中所有图像和可视化均由作者创建](img/b5481f6a21380f247c62826a36c63b37.png)
...
我认为迭代周期对于开发过程至关重要，我的目标是优化它，而不是消除它。为了使概念更具体，我将使用[Kaggle 欺诈检测数据集](https://www.kaggle.com/datasets/mlg-ulb/creditcardfraud/data)（DbCL 许可）作为一个案例研究。对于建模，我将利用*TabNet*和*Optuna*进行超参数优化。关于这些工具的更深入解释，请参阅我之前的[文章](https://medium.com/towards-data-science/real-world-use-cases-forecasting-service-utilization-using-tabnet-and-optuna-26308db615c3)。
...
![显示使用权重 0.5 的 BCE 损失训练的模型和 F1 分数评估结果的混淆矩阵](img/ca35ab6fc73071b623f3dac9bb6ec732.png)
...
![F-beta 度量推导以获得所需方程的图像。图由作者提供。](img/05e0001339076a595e62618ba2e5046e.png)
...
![显示使用权重 0.995 进行 BCE 损失训练并使用 F14 分数评估的模型结果的混淆矩阵。](img/951473f49d667e8e5dd97a6a320f4ef8.png)
...
将数据集分割以尽可能接近现实世界的场景。如果你的数据有时间维度，请使用它来创建有意义的分割。我在之前的[文章](https://medium.com/towards-data-science/real-world-use-cases-forecasting-service-utilization-using-tabnet-and-optuna-26308db615c3)中已经讨论过这一点，对于那些想要看到更多示例的人来说。
...
![验证数据集的混淆矩阵，beta 值为 1，无加权损失。图片由作者提供](img/c8f55caaff23eff8321c9df28f17d2b9.png)
...
如果任务是分类，考虑在输出上实施一个阈值。这样，只有模型确信的标签才会被输出。否则，模型将完成任务，但不会标记数据。我在这篇文章中深入探讨了这一点[文章](https://medium.com/towards-data-science/mastering-model-uncertainty-thresholding-techniques-in-deep-learning-1f1ab3912fd1)。

***回归。***

对于分类情况中的阈值处理，回归的对应做法是引入一个置信区间，而不是提供一个点估计。置信区间的宽度由业务用例决定，但当然，这种权衡是在预测准确性和预测确定性之间进行的。这个话题在之前的[文章](https://medium.com/towards-data-science/real-world-use-cases-forecasting-service-utilization-using-tabnet-and-optuna-26308db615c3)中进行了进一步的讨论。
...
![图片](img/c6f90572ef8b9e6a1d46bb7828e86f2a.png)
...
![图片](img/252b67ba2d39b56ff3b4695499e9510b.png)![图片](img/bbf30c5702bdac373e946776caf0f881.png)![图片](img/54430a96a55353c76ac829f89bbc094e.png)![图片](img/c957ac4560ef622d5913ff1023780bd7.png)![图片](img/de00c2055d8c93b0513114c80ecd002b.png)
...
我希望这篇文章提供了有价值的见解和灵感。如果您有任何评论或问题，请随时联系。您也可以在[LinkedIn](https://www.linkedin.com/in/hampus-gustavsson-23721a116/)上与我联系。
