...
> 原文：[`towardsdatascience.com/three-essential-hyperparameter-tuning-techniques-for-better-machine-learning-models/`](https://towardsdatascience.com/three-essential-hyperparameter-tuning-techniques-for-better-machine-learning-models/)
...
**clf_1**和**clf_3**模型执行 SVM 线性分类，而**clf_2**模型执行非线性分类。在这种情况下，用户可以通过更改**SVC()**类中的*‘kernel’*超参数的值来执行线性和非线性分类任务。
...
![](img/d9dc223ba77defad7b6cb6fd6cb9b779.png)
