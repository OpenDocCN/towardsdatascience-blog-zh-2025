...
> 原文：[https://towardsdatascience.com/mastering-nlp-with-spacy-part-4/](https://towardsdatascience.com/mastering-nlp-with-spacy-part-4/)
...
基于Transformer架构，我们今天能够创建 **考虑整个上下文的模型** 来生成单词的向量表示。

![图片](../Images/6efd359213fb289849b0f8ddabfa5ae3.png)

src: [https://arxiv.org/abs/1706.03762](https://arxiv.org/abs/1706.03762)

该网络引入的主要创新是 **多头注意力块**。如果您不熟悉它，我最近写了一篇文章关于这个话题：[https://towardsdatascience.com/a-simple-implementation-of-the-attention-mechanism-from-scratch/](https://towardsdatascience.com/a-simple-implementation-of-the-attention-mechanism-from-scratch/)
...
BERT 由 Google 在 2018 年推出，你可以在这里了解更多信息：[https://arxiv.org/abs/1810.04805](https://arxiv.org/abs/1810.04805)

BERT 是一系列编码器层。这个模型有两种大小。BERT base 包含 12 个编码器，而 BERT large 包含 24 个编码器

![](../Images/b42fc656fbfaea6329010bc22db3ae6d.png)

src: [https://iq.opengenus.org/content/images/2021/01/bert-base-bert-large-encoders.png](https://iq.opengenus.org/content/images/2021/01/bert-base-bert-large-encoders.png)
...
RoBERTa 模型建立在 BERT 之上，有一些关键的不同之处：[https://arxiv.org/abs/1907.11692](https://arxiv.org/abs/1907.11692)。
...
![](../Images/a3ef9102e2a48fe9994eb58e3d8b62b2.png)
