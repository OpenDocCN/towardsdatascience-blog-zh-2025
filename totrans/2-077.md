...
> 原文：[`towardsdatascience.com/mastering-nlp-with-spacy-part-2/`](https://towardsdatascience.com/mastering-nlp-with-spacy-part-2/)
...
![](img/fc6bf73605c81be0927307c92fd580c2.png)
...
![](img/43d5e045e40eb9810e123d7028ba4b88.png)
...
![](img/58fb59defc32209b6fd66ddfb1dd4512.png)
...
![图片](img/39bc559d24d1a57990d9003a2f725d97.png)

src: [`spacy.io/usage/visualizers`](https://spacy.io/usage/visualizers)

在依存关系中，我们始终有一个**父词**，也称为**头部**，和一个**依赖词**，也称为**子词**。在短语“红色汽车”中，汽车是头部，红色是子词。

![图片](img/4cfcfa754c6800ca89c1d09131776ac7.png)
...
要获取完整的列表，请查看此网站：[`universaldependencies.org/u/dep/index.html`](https://universaldependencies.org/u/dep/index.html)
...
我们可以使用 spaCy 的**display**模块来可视化依存树。让我们看看一个例子。
...
![](img/a8ddb44f183ec7c6a4fc7d5046ee39ff.png)
...
![](img/dfaeca73d8bfc795b4992b9693991dee.png)

src: [`spacy.io/usage/visualizers#ent`](https://spacy.io/usage/visualizers#ent)
...
命名实体可以通过 spaCy 的`doc.ents`属性访问
...
![](img/c277e07960ba1f7bdf439dbf25f17387.png)
