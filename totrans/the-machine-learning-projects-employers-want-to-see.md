...
> 原文：[`towardsdatascience.com/the-machine-learning-projects-employers-want-to-see/`](https://towardsdatascience.com/the-machine-learning-projects-employers-want-to-see/)
...
+   [**一张图胜过 16×16 个词：大规模图像识别的 Transformer**](https://arxiv.org/abs/2010.11929)
...
1.  对于每个主题，写下你感兴趣回答或解决的问题的五个问题。所以，总共将有 25 个潜在的问题。
...
+   你可以使用生产代码、云系统如 AWS，以及使用**[Docker](https://medium.com/data-science/from-chaos-to-consistency-docker-for-data-scientists-240372adff18?sk=68898c01460f59a75617244d19f101d1)**和**[Kubernetes](https://kubernetes.io/)**来部署整个项目。
...
> [如何定制简历，让我获得了 10 万美元以上的数据科学和机器学习报价](https://towardsdatascience.com/this-resume-landed-me-100k-data-science-ml-offers/)
