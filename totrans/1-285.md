...
> 原文：[`towardsdatascience.com/a-visual-guide-to-tuning-gradient-boosted-trees/`](https://towardsdatascience.com/a-visual-guide-to-tuning-gradient-boosted-trees/)
...
除了这个，一如既往，没有理论，没有数学——只有图表和超参数。就像以前一样，我将使用 scikit-learn 的加利福尼亚住房数据集（CC-BY），与我在之前的帖子中描述的相同的一般过程，代码在[`github.com/jamesdeluk/data-projects/tree/main/visualising-trees`](https://github.com/jamesdeluk/data-projects/tree/main/visualising-trees)，下面的所有图像都是我制作的（除了 GIF，它来自[Tenor](https://tenor.com/view/ryu-haduken-street-figfter-gif-601629130662770429)）。

## 一个基本的梯度提升树

从一个基本的 GBT 开始：`gb = GradientBoostingRegressor(random_state=42)`。与其他树类型类似，`min_samples_split`、`min_samples_leaf`、`max_leaf_nodes`的默认设置分别是 2、1、`None`。有趣的是，默认的`max_depth`是 3，而不是决策树/随机森林中的`None`。值得注意的超参数，我稍后会进一步探讨，包括`learning_rate`（梯度有多陡，默认 0.1）和`n_estimators`（与随机森林类似——树的数量）。
...
![图片](img/0725dca162d9d580374f53f339430770.png)
...
![图片](img/720e66d982820f959dd13cb7a2bca69f.png)
...
![图片](img/d1c423aa7b2941f9b422205d4dc5f085.png)

让我们更进一步！测试数据有超过 5000 个块需要预测；我们可以遍历每个块，并对每个迭代进行预测！

![图片](img/8489d325e3739efbeefb3ade4c5ee81d.png)

我喜欢这个图表。

![图片](img/d19731e1fa54673fc258c8e8532fb437.png)
...
![图片](img/40597890e5b550f9221dc9f977046481.png)
...
![图片](img/2a3b81cf1fd1d6847171e31afb1ee20b.png)
...
![](img/3a0bdffd4b9f4d12d3b96c20cf6979ec.png)
...
![](img/7cff0b6d1d0465e6a80fa4c1420da8c6.png)
...
![](img/d504df0a68c4bec353925cf948cd57d5.png)
...
![](img/8073371cd978f701916a7a344e4800c3.png)
