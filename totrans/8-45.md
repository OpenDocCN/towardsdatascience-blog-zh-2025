...
但这里的挑战是什么？在大多数情况下，指标的分布不是正态的，这使得*p-value*的计算更加复杂。
...
我们可以应用一些小技巧，将概率密度函数转换为累积分布函数（CDF）。在这种情况下计算*p-value*要容易得多。

![累积分布函数（CDF），图片由作者提供](img/d48e2cea0e4f99c3191a7ea23626f664.png)
...
![累积分布函数（CDF），图片由作者提供](img/2ac814bc614acce7ae38ce6d9095d5c2.png)
...
![使用样条插值的累积分布函数，图片由作者提供](img/761f97fc2dbf01a1fe84ec9b1f616a98.png)
...
![使用分段三次 Hermite 插值的累积分布函数，图片由作者提供](img/d047391b805dffe5e9457dda81feb3ac.png)
...
![临界区域，图片由作者提供](img/66b351296a71e8afeb2979fe9607c2f7.png)

临界区域，图片由作者提供

为了做到这一点，让我们创建一个简单的函数`_calculate_pvalue`：
