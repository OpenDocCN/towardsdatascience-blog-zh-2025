...
> 原文：[`towardsdatascience.com/the-upstream-mentality-why-ai-ml-engineers-must-think-beyond-the-model/`](https://towardsdatascience.com/the-upstream-mentality-why-ai-ml-engineers-must-think-beyond-the-model/)

<mdspan datatext="el1755625190745" class="mdspan-comment">你的 AI 系统</mdspan>在生产中完美运行了数周，突然一切都崩溃了。也许是因为你的 ML 模型的精度一夜之间下降，或者你的 LLM 代理未能预订肯定存在的航班。罪魁祸首？很少是模型本身。通常，是上游表中一个模式的更改，一个没有人告诉你的 API 重命名，或者一个永远没有更新的知识库。
...
现实世界的例子证明了这种影响。Stripe 通过修复“脆弱的编排和遗留脚本”，将正常运行时间从 84%提高到 99.9%，直接保护了收入和信任 ([link](https://ctomagazine.com/tackling-tech-debt-boosts-agility-data-engineering/#:~:text=After%20investing%20three%20months%20to%20rebuild%20its%20platform%2C%20Stripe%20increased%20operational%20uptime%20from%2084%25%20to%2099.9%25%2C%20resulting%20in%20smoother%20customer%20experiences%20and%20faster%20deployment%20of%20new%20features.%C2%A0))). Uber 用 Michelangelo，他们的标准化机器学习平台，替换了脆弱的、一次性的管道 ([link](https://www.uber.com/en-JO/blog/michelangelo-machine-learning-platform/?utm_source=chatgpt.com))。
...
![图片](img/6a1fe480753c5a2bd3bba3bb4771554d.png)
...
![](img/ee505379018e39d00b18e385e33e1bfa.png)
...
1.  **翻转它**：模型通常不会自行改变，但它们的输入会改变。在机器学习的情况下，您的数据工程团队将交易金额列从美元改为美分（1.50 → 150），而没有通知任何人。在 LLM 的情况下，产品数据库 API 发生了变化：“价格”字段被重命名为“list_price”，而没有更新搜索服务

1.  **重构它**：而不是在模型级别修复问题，修复系统——强制执行数据合约，防止部署模型使用时列发生变化，或在 API 和依赖服务之间添加自动模式合约测试
...
1.  **翻转它**：自第二季度以来，向量数据库没有更新新的产品文档。产品团队一直在 Confluence 中更新文档，但没有人将此与 AI 系统的知识库联系起来
...
![图片](img/4d5e882aead8fa11b91ae08c31ec5720.png)
...
![图片](img/81fe10c760191a54f68552590a139cee.png)
...
![图片](img/e91ce53f6a45da4728b7ebf825f129d5.png)
...
![图片](img/eb9d0a1cbbd16b04be4d6f8743f6c195.png)
