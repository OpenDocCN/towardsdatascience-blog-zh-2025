...
> 原文：[`towardsdatascience.com/artificial-intelligence-machine-learning-deep-learning-and-generative-ai-clearly-explained/`](https://towardsdatascience.com/artificial-intelligence-machine-learning-deep-learning-and-generative-ai-clearly-explained/)
> 
...
> 
> ![](img/5a42f81ea5c1964cc139df2d33538196.png)
> 
...
> +   历史销售价格。
> +   
> ![图片](img/f8637ef0c89968e9f4657c7531cb6927.png)
> 
> *表 1 — 数据示例（由作者使用*Excalidraw*创建）*
> 
> 数千甚至数百万个过去的例子。
> 
> 这些数据被提供给机器学习模型作为训练数据。
> 
> ![图片](img/64947ff8ecb68f399ba37b941ca089ef.png)
> 
> *图 2 — 机器学习流程（由作者使用*Excalidraw*创建）*
> 
> ### 但使用数据“训练模型”实际上意味着什么？
> ### 
...
> +   然后将预测与现实进行比较。
> +   
> ![图片](img/06f2c16121ad7eee10dd5c6cbe2d7206.png)
> 
> *图 3 — 训练/测试数据（由作者使用*Excalidraw*创建）*
> 
...
> 这个转换步骤是强制性的。
> 
> ![](img/237f6facc17f63d6c286c84727567c5b.png)
> 
...
> ### 层作为渐进表示
> ### 
> ![](img/a33f2a9794dc74df79d40ada58d77f2b.png)
> 
...
> ## 生成式人工智能：从分析到创造
> ## 
> ![图片](img/6061c9a52d6ad7b2de51d9275e7df674.png)
> 
...
> ### 但是，我们已经完成了吗？几乎。
> ### 
> ![](img/0c669459595e24eb9c8b2edad140b2ec.png)
> 
> *图 6——2025 年的完整 AI 生态系统（由作者使用*Excalidraw*创建)*
> 
> 到目前为止，我们已经涵盖了**核心 AI 生态系统**：人工智能、机器学习、深度学习和生成式 AI——以及它们如何自然地相互构建。
> 
> 如果你正在阅读这篇文章，那么你很可能已经在日常生活中使用 ChatGPT 等工具。这里我不会深入探讨——这值得一篇单独的文章。
> 
> 然而，有一个重要的最终想法值得记住。
> 
> 之前，我们说**生成式 AI 是深度学习的延续**，专门学习足够好的模式来生成遵循这些模式的新数据。
> 
