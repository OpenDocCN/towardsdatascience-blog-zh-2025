...
> 原文：[`towardsdatascience.com/optimize-for-impact-how-to-stay-ahead-of-gen-ai-and-thrive-as-a-data-scientist/`](https://towardsdatascience.com/optimize-for-impact-how-to-stay-ahead-of-gen-ai-and-thrive-as-a-data-scientist/)
...
<mdspan datatext="el1753384598901" class="mdspan-comment">大多数数据科学家，即使是中级数据科学家引以为傲的工作——那些让他们觉得自己聪明、技术性强、不可替代的东西——现在已经成为基本自动化。不舒服的问题不是人工智能能否像人类一样做好这些事情，而是人类自己是否还在通过做这些事情来增加价值。人工智能已经足够好，可以完成典型数据科学家日常生活中的大多数常规工作；在商业领域，以 10%的成本和 1%的时间做到足够好通常就能获胜。
...
将你的指标分为四个层次。**北极星指标**定义了长期成功并使整个公司保持一致——比如 YouTube 跟踪每周活跃创作者，以将他们的使命集中在内容生产上。**支持性指标**分解并推动北极星指标的发展，揭示战略行动最需要的地方——比如创作者留存率或每位创作者的上传量。**护栏指标**在优化过程中防止意外损害，确保质量和信任即使在激进的增长下也能保持完整。而**运营指标**保持系统日常运行——对于执行至关重要，但战略并不在这里。
