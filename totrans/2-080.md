...
> 原文：[`towardsdatascience.com/when-models-stop-listening-how-feature-collapse-quietly-erodes-machine-learning-systems/`](https://towardsdatascience.com/when-models-stop-listening-how-feature-collapse-quietly-erodes-machine-learning-systems/)
...
![](img/ba64b74a86c3cb13fc62fd1cf5243ea8.png)
...
标准的 MLOps 管道监控预测漂移、分布偏移或推理错误。但它们很少跟踪特征重要性的演变。SHAP 或[LIME](https://www.datacamp.com/tutorial/explainable-ai-understanding-and-trusting-machine-learning-models)等工具通常用于静态快照，有助于模型可解释性，但不是设计来跟踪崩溃的注意力。
...
![图片](img/baf704a7c349a4fdaf57a5123c3b1aa9.png)
...
在训练中引入归因感知正则化可以保留更广泛的输入依赖。这可以通过惩罚[SHAP 值](https://www.datacamp.com/tutorial/introduction-to-shap-values-machine-learning-interpretability#:~:text=for%20interpreting%20models.-,What%20are%20SHAP%20Values?,on%20the%20interaction%20between%20features.)的方差或通过对顶级-N 特征的总体重要性施加约束来实现。目标不是标准化，而是防止过早依赖。
