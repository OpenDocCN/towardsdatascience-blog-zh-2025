...
如果你了解 Python 但刚开始接触 GEE（就像我之前一样），你应该知道 GEE 为处理卫星图像提供了优化的函数。我们在这里不会深入探讨这些函数的细节；你应该查看[官方文档](https://developers.google.com/earth-engine/guides/getstarted)。
...
![帕乌特盆地（厄瓜多尔）2010-2020 年土壤湿度指数月平均值。使用 Google Earth Engine Python API 和 Geemap 创建的图像。数据来源：欧洲航天局（2025）；Lehner, B., Grill G. (2013) 和 Lehner, B., Verdin, K., Jarvis, A. (2008)](img/e42d6dd0a982c16acd1a273460e1cff8.png)
...
这就是 Geemp 发挥作用的地方。[Geemap](https://geemap.org/)是一个 Python 包，旨在通过 GEE 进行交互式地理空间分析和可视化。
...
Friedl, M., Sulla-Menashe, D. (2022). *MODIS/Terra+Aqua Land Cover Type Yearly L3 Global 500m SIN Grid V061* [数据集]. 美国国家航空航天局 EOSDIS 陆地过程分布式主动存档中心。于 2025 年 1 月 15 日从[`doi.org/10.5067/MODIS/MCD12Q1.061`](https://doi.org/10.5067/MODIS/MCD12Q1.061)访问。
